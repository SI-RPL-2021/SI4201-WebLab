...
class PelatihanController extends Controller
{
    ...
    public function notifpelatihan(){ // Anggota lihat notifikasi pelatihan
        ...
        $date = date('Y-m-d');
        $pelatihan = Pelatihan::where('status_aproval','aproved')->where('study_group', $group)->where('tgl_pelatihan','>=',$date)->get(); // Anggota hanya melihat notifikasi pelatihan yang telah di verifikasi dan sesuai dengan study group mereka
