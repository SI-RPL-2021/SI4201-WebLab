...
@endif
<form action="pelatihan/create" method="get">
    {{-- @csrf --}}
    <div class="form-group ml-3">
        <label>Nama Pelatihan</label>
        <input type="text" class="form-control" name="nama_pelatihan" style="width:95%">
    </div>
    <div class="form-group ml-3">
    ...
    <div class="form-group ml-3">
        ...
        <input type="date" class="form-control" name="tgl_pelatihan" style="width:95%">
    </div>
    <div class="form-group ml-3">
        <label>Jam Pelatihan</label>
        <input type="time" class="form-control" name="jam_pelatihan" style="width:95%">
    </div>
    <div class="form-group ml-3">
        <label>Link</label>
